...
const { create, list, update, remove, listSelect, createUsageType, listUsageType, readUsageType, updateUsageType, removeUsageType, listUsageTypeSelect, is_active, statusUsageType, statusUsageTypeIsSee, listUsageTypeSelectMember } = require('../controllers/carUsage')
...
router.get('/select-carusagetype-member', authCheck, roleCheck(['admin']),listUsageTypeSelectMember)
