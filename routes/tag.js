...
const { create, list, listSelect, update, is_active, remove, addMembers, removeTagFromMember, listMemberByTag } = require('../controllers/tag')
...
router.get('/list-memberByTag/:id', authCheck, roleCheck(['admin', 'staff']), listMemberByTag)
