...
const { create, list, remove, update, read, isActivePremium, searchPremiumToCompare, createPremiumToCompare, searchPremiumMember, createPremiumToCompareMember, previewCompare, listPremiumCart } = require('../controllers/insrancPremium')
...
router.get('/list-comparemember', authCheck,  listPremiumCart)
