...
const { create, list, update, remove, read, is_active, listSelect } = require('../controllers/group_member')
...
router.get('/select-groupmember', authCheck, roleCheck(['admin', 'staff']), listSelect)
...
router.put('/status-groupmember/:id', authCheck, roleCheck(['admin']), is_active)
