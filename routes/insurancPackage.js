...
const { create, list, update, remove, listSelect, read, readEdit, copy, StatusIsActive, updateGroupDiscount } = require('../controllers/insurancPackage')
...
router.patch('/package-group-discount', authCheck, roleCheck(['admin']), updateGroupDiscount)
