...
const { createCompare, getDetailCompare, comparePDF, compareJPG, listCompare, removeCompare, detailCompareEdite, searchCompare, listPinCompare, copyCompare } = require('../controllers/compare');
