...
const { create, list, listSelect, read, update, is_active, remove, createGroupCredit, listGroupCredit, listSelectGroupCredit, readGroupCredit, updateGroupCredit, isActiveGroupCredit, removeGroupCredit } = require('../controllers/bank')
...
router.get('/read-group-credit/:id', authCheck, roleCheck(['admin']),readGroupCredit)
