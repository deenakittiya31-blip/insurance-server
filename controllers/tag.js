...
exports.listSelect = async(req, res) => {
    try {
        const result = await db.query('SELECT id, tag_named FROM tag WHERE is_active = true ORDER BY id DESC')
...
//     try {
//         const { id } = req.params
//         const result = await db.query('SELECT id, tag_name FROM tag WHERE id = $1', [id])
